        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#" data-uri="/AlljokesPage">All jokes</a>
              </li> 
              <li class="nav-item">
                <a class="nav-link" href="#" data-uri="/AddjokesPage">Add a jokes</a>
              </li>         
              <li class="nav-item">
              <a class="nav-link" href="#" data-uri="/newPage">newPage</a>
            </li>                   
            </ul>
          </div>
        </div>
